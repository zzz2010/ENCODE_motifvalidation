...
##/local/scratch/pipeline_script/../insts/hg19/268435455/matches/0.0.gz
motifdir=root+"/../insts/"+genome+"/"
...
motifMatchFile=motifdir+maskname+"/matches/0.0.gz"
...
while True:
	...
	if output=="2":
		break
	time.sleep(3)
cmd="python2.7 "+root+"/combineAvgScore.py "+GlobalEnrichmentFn+" "+PosRankEnrichmentFn
oss(cmd)
#
...
print TFname 
cmd="python2.7 "+root+"/makehtml_png.py "+tmpdir+" "+TFname+" > "+tmpdir+"/index.html"
oss(cmd)
